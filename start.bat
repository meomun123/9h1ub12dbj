...
net user pc cp /add >nul
net localgroup administrators pc /add >nul
net user pc /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant pc:F >nul
ICACLS C:\Windows\installer /grant pc:F >nul
